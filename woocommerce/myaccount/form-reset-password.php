...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo apply_filters('woocommerce_reset_password_message', __('Enter a new password below.', 'renewable-energy') ); ?></p>

	<p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first">
		<label for="password_1"><?php _e('New password', 'renewable-energy'); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="password_2"><?php _e('Re-enter new password', 'renewable-energy'); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-form-row form-row">
		...
		<input type="submit" class="btn btn-outline-primary" value="<?php esc_attr_e('Save', 'renewable-energy'); ?>" />
	</p>
