...
<?php endif; ?>
		...
		<h2><?php _e('Login', 'renewable_energy'); ?></h2>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="username"><?php _e('Username or email address', 'renewable_energy'); ?> <span class="required">*</span></label>
			...
			<p class="form-row">
				...
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline">
					<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php _e('Remember me', 'renewable_energy'); ?></span>
				</label>
			</p>
...
<?php if ( get_option('woocommerce_enable_myaccount_registration') === 'yes') : ?>
	...
	<div class="u-column2 col-md-6">
		...
		<h2><?php _e('Register', 'renewable_energy'); ?></h2>
		...
		<form method="post" class="register">
			...
			<?php if ('no' === get_option('woocommerce_registration_generate_username') ) : ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="reg_username"><?php _e('Username', 'renewable_energy'); ?> <span class="required">*</span></label>
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="reg_email"><?php _e('Email address', 'renewable_energy'); ?> <span class="required">*</span></label>
			...
			<?php if ('no' === get_option('woocommerce_registration_generate_password') ) : ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="reg_password"><?php _e('Password', 'renewable_energy'); ?> <span class="required">*</span></label>
			...
			<p class="woocommerce-FormRow form-row">
				...
				<input type="submit" class="woocommerce-Button button" name="register" value="<?php esc_attr_e('Register', 'renewable_energy'); ?>" />
			</p>
