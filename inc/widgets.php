 ...
 */
if (!function_exists('renewable_energy_slbd_count_widgets')) {
    function renewable_energy_slbd_count_widgets($sidebar_id) {
...
if (!function_exists('renewable_energy_widgets_init')) {
    /**
    ...
    function renewable_energy_widgets_init() {
        ...
        register_sidebar(array(
            ...
            'id' => 'statichero',
            'description' => 'Static Hero widget. Positioned under Homepage\'s Hero Slider',
...
} // endif function_exists('renewable_energy_widgets_init').
add_action('widgets_init', 'renewable_energy_widgets_init');
