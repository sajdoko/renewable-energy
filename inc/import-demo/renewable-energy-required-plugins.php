 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Renewable Energy
 ...
 */
require_once get_template_directory() . '/inc/import-demo/class-tgm-plugin-activation.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
...
function renewable_energy_register_required_plugins() {
	...
	$plugins = array(
		...
		// array(
		// 	'name'               => 'Renewable Energy CPT', // The plugin name.
		// 	'slug'               => 'renewable-energy-cpt', // The plugin slug (typically the folder name).
		// 	'source'             => get_template_directory() . '/inc/import-demo/plugins/renewable-energy-cpt.zip', // The plugin source.
		...
		// ),
		array(
			'name'        => 'Renewable Energy CPT',
			'slug'        => 'renewable-energy-cpt',
			'required'    => false, // If false, the plugin is only 'recommended' instead of required
		),
		array(
